...
// It marshalls an ISBN and filters the books based on it.
...
// GetBook returns a book for a given ISBN
...
// UpdateBook updates a book for a given ISBN
...
// DeleteBook deletes a book by a given ISBN
